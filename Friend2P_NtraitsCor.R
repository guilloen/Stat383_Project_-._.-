...
S2C = cor(data$FriendP, data$Sus)
S2D = cor(data$FriendP, data$Anx)
S2E = cor(data$FriendP, data$Sol)
...
write_xlsx(df, "C:/Users/Elizabeth/Documents/Fall 2023/STAT 383/STAT Project/Some helpful codes-20231203/Friend2P_NtraitsCor.xlsx")